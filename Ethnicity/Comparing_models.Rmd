...
#df_comp_factor$author_eth <- factor(df_comp_factor$author_eth,levels=c("White","Black","Hispanic","API", "Unknown","AIAN"))
#df_comp_factor$closer_eth <- factor(df_comp_factor$closer_eth,levels=c("White","Black","Hispanic","API", "Unknown"))
#df_comp_factor$author_eth <- factor(df_comp_factor$author_eth, levels = c("White", "Black", "Hispanic", "API", "Unknown", "AIAN"))
#df_comp_factor$closer_eth <- factor(df_comp_factor$closer_eth, levels = c("White", "Black", "Hispanic", "API", "Unknown", "AIAN"))
