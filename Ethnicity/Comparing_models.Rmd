...
odds_ratios_unn <- exp(fixed_effects)
#conf_intervals <- confint(bootstrapped_models[[i]], which = "fixed")
print(model_summary_unn, correlation=TRUE)
...
sample <- df_merged_factored[indices, ]
...
odds_ratios_qua <- exp(fixed_effects)
#conf_intervals <- confint(bootstrapped_models[[i]], which = "fixed")
...
odds_ratios_res <- exp(fixed_effects)
#conf_intervals <- confint(bootstrapped_models[[i]], which = "fixed")
print('The model summary and correlation:')
...
odds_ratios_rep <- exp(fixed_effects)
#conf_intervals <- confint(bootstrapped_models[[i]], which = "fixed")
print('The model summary and correlation:')
...
# Combine the "dupecessary" pull requests with the bootstrapped merged data
...
odds_ratios_dup <- exp(fixed_effects)
#conf_intervals <- confint(bootstrapped_models[[i]], which = "fixed")
print('The model summary and correlation:')
...
odds_ratios_mc <- exp(fixed_effects)
#conf_intervals <- confint(bootstrapped_models[[i]], which = "fixed")
print('The model summary and correlation:')
...
odds_ratios_sta <- exp(fixed_effects)
#conf_intervals <- confint(bootstrapped_models[[i]], which = "fixed")
print('The model summary and correlation:')
...
set.seed(43)
category <- 'No Comment'
df_nonmerged_factor_nc <- df_nonmerged[df_nonmerged$manual_analysis == category, ]
...
formula <- status ~  commit_counts + code_changes_counts + prs_experience + prs_succ_rate + prs_popularity + prs_watched_repo + prs_tenure_mnth + prs_main_team_member +
repo_pr_tenure_mnth + repo_pr_popularity + repo_pr_team_size + perc_external_contribs + intra_branch + pr_files_changed + pr_lines_changed + (1 | repo_id) + (1 | author_id)
...
odds_ratios_nc <- exp(fixed_effects)
#conf_intervals <- confint(bootstrapped_models[[i]], which = "fixed")
print('The model summary and correlation:')
...
```
```{r}
unique(df_nonmerged$manual_analysis)
```
### No Reason
```{r}
...
set.seed(44)
category <- 'No Reason'
df_nonmerged_factor_nr <- df_nonmerged[df_nonmerged$manual_analysis == category, ]
...
odds_ratios_nr <- exp(fixed_effects)
#conf_intervals <- confint(bootstrapped_models[[i]], which = "fixed")
print('The model summary and correlation:')
...
set.seed(44)
category <- 'Successful'
df_nonmerged_factor_suc <- df_nonmerged[df_nonmerged$manual_analysis == category, ]
...
odds_ratios_suc <- exp(fixed_effects)
#conf_intervals <- confint(bootstrapped_models[[i]], which = "fixed")
print('The model summary and correlation:')
...
formula <- status ~  comments_counts + commit_counts + code_changes_counts + prs_experience + prs_succ_rate + prs_popularity + prs_watched_repo + prs_tenure_mnth + prs_main_team_member + repo_pr_tenure_mnth + repo_pr_popularity + repo_pr_team_size + prs_followed_pri + perc_external_contribs + intra_branch +pr_files_changed + pr_lines_changed + (1 | repo_id) + (1 | author_id)
...
combined_data <- rbind(df_nonmerged_factor, sample)
