...
## Encoding the manual analysis label and factoring the rest
```{r}
...
repo_pr_tenure_mnth + repo_pr_popularity + repo_pr_team_size + perc_external_contribs + pr_opened_at + pr_files_changed + pr_lines_changed + intra_branch + (1 | repo_id) + (1 | author_id)
...
```{r}
df_nonmerged_factor_unn <- df_comp
